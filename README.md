...
- [x] Ambient beds — a low crowd murmur loop + an NFL-Films-style procedural music bed (brass + pad + timpani) that ducks for the snap and swells back between plays
